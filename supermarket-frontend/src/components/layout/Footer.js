      ...
      <div className="container py-5">
        <div className="row">
          <div className="col-md-3 mb-4">
            <h3 className="fs-5 fw-semibold mb-3">SuperMarket</h3>
            <p className="text-secondary">Your one-stop shop for fresh groceries and household essentials.</p>
          </div>
          <div className="col-md-3 mb-4">
            ...
            <ul className="list-unstyled">
              ...
              <li className="mb-2"><Link to="/categories" className="text-secondary text-decoration-none">Categories</Link></li>
              <li className="mb-2"><Link to="/about" className="text-secondary text-decoration-none">About Us</Link></li>
            </ul>
          </div>
          <div className="col-md-3 mb-4">
            <h3 className="fs-5 fw-semibold mb-3">Customer Service</h3>
            <ul className="list-unstyled">
              ...
              <li className="mb-2"><Link to="/returns" className="text-secondary text-decoration-none">Returns & Refunds</Link></li>
            </ul>
          </div>
          <div className="col-md-3 mb-4">
            <h3 className="fs-5 fw-semibold mb-3">Connect With Us</h3>
        ...
        <div className="border-top border-secondary mt-4 pt-4 text-center text-secondary">
          <p>&copy; {new Date().getFullYear()} SuperMarket. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
